...
// Название языка ПО-РУССКИ — для своих. Админ, инструктор и телеграм-бот
// смотрят на заявку по-русски, и «корейский» в карточке читается с одного
// взгляда, а «한국어» приходится опознавать.
export const LOCALE_NAMES_RU: Record<AppLocale, string> = {
  ru: "русский",
  en: "английский",
  vi: "вьетнамский",
  ko: "корейский",
...
// Наш ли это код языка. Нужна там, где значение приходит снаружи: из формы
// записи в базу попадает только то, что прошло эту проверку.
