...
// Магазин ещё не открыт для гостей (решение David, 13.09.2026): страница
// открывается, но под размытием и замком «Страница в разработке». Вошедшие
// сотрудники видят её целиком — показать начальнику и доделать. Пока флаг
// стоит, магазина нет в sitemap и поисковику сказано его не индексировать.
// Открыть магазин всем = поставить false.
export const SHOP_IN_DEVELOPMENT = true;
