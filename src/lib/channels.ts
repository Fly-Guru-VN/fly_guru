...
// счётчика переходов (api/ref-visits): всё, что шире, — не наша метка, а
// подставленный в адрес мусор, и в базу он ехать не должен.
export const LINK_TAG_RE = /^[a-zA-Z0-9_-]{1,64}$/;
