...
// Если справочник не прочитался, отдаём пустой список: форма покажет «Другой…»
// и запись всё равно можно завести. Это осознанный мягкий путь — здесь не
// деньги, а выпадашка, но в лог пишем, иначе поломка останется незамеченной.
