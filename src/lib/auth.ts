...
// Уволенный (последний рабочий день наступил). Аккаунт не удаляем — вместе с
// ним пропала бы вся история занятий и выплат, — но в кабинет не пускаем:
// человек больше не работает в школе. Граница та же, что в lib/staff → isFired:
// дата увольнения закрывает вход в этот же день, а не со следующего.
