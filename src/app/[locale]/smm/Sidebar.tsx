...
//
// Отличий от админского два: разделов двенадцать вместо шестнадцати (нет
// календаря, расчёта выплат, членов клуба и услуг — это не его работа) и в
// профиле нет чистой прибыли: деньги школы он видит только как выручку, во
// вкладке «Статистика».
