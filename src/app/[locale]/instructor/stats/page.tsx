    ...
    <div>
      ...
      <div className="mt-3 rounded-2xl border-2 border-primary bg-surface p-5">
        ...
        <div className="mt-3 space-y-1 text-sm text-muted">
          ...
          {/* Со скольких абонементов сложилась доля — отдельной строкой от
              «продал сам» (просьба начальника от 25.08.2026): это разные
              цифры, и раньше вместо первой не было ничего. */}
          <p>
            Посчитано с {stats.sharedSubsCount} абонемент(ов) · продал сам:{" "}
            {stats.paidSubsCount}
          </p>
        </div>
        <p className="mt-3 text-xs text-muted">
          15% с занятий дня делятся поровну между теми, кто в этот день открыл
          смену — неважно, кто оформил запись и стояла ли смена в календаре
          ({stats.sharedDays} дн. в этом периоде). В дни, когда смен не было
          вовсе, 15% идут тому, кто записал ({stats.ownDays} дн.).
          Абонементный котёл общий: доля капает с каждого абонемента,
          оплаченного в дни, когда ты был в деле, — кто бы его ни продал.
        </p>
      </div>
