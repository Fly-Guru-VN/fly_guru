...
// страница перерисовывалась прежней, а форма ещё и рапортовала «Сохранено ✓»
// — инструктор шёл дальше, считая, что запись поправлена. Правило простое:
// не смогли записать — говорим об этом вслух.
//
// Настоящую причину Next в проде наружу не отдаёт (только digest) — она в
// логах сервера рядом с «[instructor] …».
