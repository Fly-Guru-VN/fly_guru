...
//
// ⚠️ СЕЙЧАС ЭТА СТРАНИЦА НЕ ОТКРЫВАЕТСЯ. С 17.08.2026 реф-ссылка ведёт сразу на
// главную (см. page.tsx рядом): там уже есть кнопка записи, и гость видит
// обычный сайт, а не отдельный лендинг. Файл оставлен целиком, чтобы лендинг
// можно было доработать и вернуть — для этого достаточно переименовать его
// обратно в page.tsx (и убрать редирект). Пока это не роут, а просто файл
// рядом с роутом: Next.js страницей его не считает.
