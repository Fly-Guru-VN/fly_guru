...
// вообще».
//
// С 27.07.2026 флаг ничего не требует от системы: смену все открывают одинаково
// (фото на пляже), а оборудование снимает тот, кому удобно. Пометка осталась
// как договорённость между людьми — кто за осмотр отвечает.
