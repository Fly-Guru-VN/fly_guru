...
export function RecordClientForm({
  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      {/* Метка «это запись клиента, а не внесение прошлого». По ней экшен
          понимает, что начальнику, поставившему инструктором себя, надо открыть
          смену: он записал занятие на себя — значит был на пляже. Во вкладке
          «Сессии» админ вносит чужое прошлое, и смена там означала бы неправду.
          Роль и «инструктор = я» проверяет сервер, поле только различает формы. */}
      <input type="hidden" name="autoShift" value="1" />
