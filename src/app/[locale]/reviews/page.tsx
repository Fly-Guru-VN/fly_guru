...
// трёх рамок-плейсхолдеров, нарисованных дизайнером прямо в макете
// photo_video/отзывы_hero/hero_png_V2.png: каждая ровно 293×94 px, лежат по
// координатам 1010,86 / 1345,197 / 1166,385 в исходнике (у него слева ещё
// 407 px прозрачных полей, которые срезает scripts/bake-reviews-hero.mjs).
// Сами рамки из картинки вытравлены тем же скриптом — плашки встают на их
// место, а до xl плашек нет, и рамки светились бы на телефоне.
// Пришлют новый макет — прогоните скрипт, он напечатает координаты рамок.
const HERO_CHIPS = [
  ...
  { name: "Илья Яковлев", text: "Непередаваемые эмоции!", rating: 5, color: "#9334e6", cx: 71.58, cy: 48.54 },
];
...
export default function ReviewsPage() {
  ...
  return (
    <>
      {/* ── Первый экран ── */}
      {/* Собран по макету hero_png_V2 (1265×890 после обрезки прозрачных полей):
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-white to-surface-2 lg:flex lg:min-h-[36.6vw] lg:items-center">
        ...
        {/* Кадр и плашки. Фотография — PNG со своими краями: скруглённый левый
            угол, волна снизу и вклеенный малый кадр в белой обводке. Ни
            подложек, ни масок ей не нужно, прозрачные края показывают фон
            страницы. Раньше малый кадр лежал отдельной картинкой поверх
            большой; с макета V2 (31.08.2026) он впечён в тот же файл, и
            подгонять его посадку кодом больше не нужно.
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:flex lg:w-[52%] lg:items-center">
          ...
          <div className="relative w-full [container-type:inline-size]">
            ...
            {/* Три коротких отзыва плашками поверх кадра — каждая ровно на
