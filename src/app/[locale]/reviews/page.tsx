...
//
// cx/cy — ЦЕНТР плашки в процентах от кадра hero.webp (1265×890). Это центры
...
const HERO_CHIPS = [
  { name: "Polina Shchegoleva", text: "Полетели с первого раза", rating: 5, color: "#1a73e8", cx: 59.25, cy: 14.94 },
  { name: "Евгений Курьянов", text: "Обязательно повторим!", rating: 5, color: "#1e8e3e", cx: 85.73, cy: 27.42 },
  { name: "Илья Яковлев", text: "Непередаваемые эмоции!", rating: 5, color: "#9334e6", cx: 74.27, cy: 46.63 },
  { name: "Юлия", text: "Дочка была в полном восторге", rating: 5, color: "#d93025", cx: 60.04, cy: 65.84 },
  { name: "Artem S.", text: "Приду второй раз однозначно!", rating: 5, color: "#e8710a", cx: 85.73, cy: 78.20 },
];
...
// Считано от ширины кадра (1265 px), поэтому обе величины — в cqw: и высота
// тоже, иначе при смене пропорции файла плашка поедет.
const CHIP_W = ((293 * 1.05) / 1265) * 100; // 24.32
const CHIP_H = ((94 * 1.05) / 1265) * 100; // 7.80
...
export default function ReviewsPage() {
  ...
  return (
    <>
      {/* ── Первый экран ── */}
      {/* Собран по макету hero_rewies (1265×890 после обрезки прозрачных полей):
          ...
          пропорцию файла 1265/890, то есть 36.6vw. Кадр лежит absolute и
