...
// Расходы механика — тот же экран и те же экшены, что у инструктора: он вносит
// рабочие траты сам и видит только свои (RLS 0016 + 0029). Админ видит их в
// своей вкладке «Расходы» в общем списке дополнительных расходов школы.
