...
// Единственная иконка не из линий, а картинкой: нарисованная пальма-силуэт из
// макета. Линейная версия рядом с плотными соседками выглядела бледной
// закорючкой. Картинка уже залита цветом --color-primary, поэтому currentColor
// ей не нужен — в подвале карточки шага иконки как раз этого цвета.
