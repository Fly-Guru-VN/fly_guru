      ...
      <div className="relative -mx-4 overflow-hidden border-y border-line bg-surface sm:-mx-6 lg:mx-0 lg:rounded-full lg:border lg:shadow-[0_16px_36px_-28px_rgba(15,34,51,0.55)]">
        ...
        >
          <SlidingHighlight
            ...
            //
            // На ПК кривая БЕЗ перелёта, в отличие от шапки. Прежняя причина
            // (плашка, проскочившая за правый край, раздувала ширину ленты, и
            // та подкручивалась сама, дёргая весь текст — замер: скачок 8 px)
            // ушла вместе с размером: теперь плашка нарисована вырезом и ряд не
            // шире вкладок. Но у крайних вкладок вырезу некуда перелетать — он
            // упирается в край ленты, и перелёт превратился бы в подрагивание
            // на «Обучении» и «Прокате». Спокойная кривая, зато одинаковая на
            // всех шести.
            motionClassName="transition-none lg:transition-[clip-path] lg:duration-[520ms] lg:ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:lg:transition-none"
