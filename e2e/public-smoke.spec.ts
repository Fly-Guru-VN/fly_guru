...
// Дымовые проверки публичного сайта. Язык браузера пришпилен к русскому: с
// появлением семи языков гость с английским браузером уезжает на /en, и тест
// молча проверял бы уже другую версию страницы. Поведение самих языков —
// в e2e/locales.spec.ts.
